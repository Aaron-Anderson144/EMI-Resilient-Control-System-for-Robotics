...
discretePlant = ss(c2d(voltagePlant, sampleTime_s, 'zoh'));
...
for sampleIndex = 1:sampleCount
    ...
    voltage_cmd_V(sampleIndex) = min( ...
        max(rawCommand, -params.control.voltageLimit_V), ...
    ...
    if sampleIndex < sampleCount
        ...
        plantState = plantA * plantState + ...
            plantB * voltage_cmd_V(sampleIndex);
...
metrics.saturatedSampleCount = nnz( ...
    abs(voltage_cmd_unsaturated_V) > params.control.voltageLimit_V);
