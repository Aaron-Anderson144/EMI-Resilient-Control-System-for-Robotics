function verification=fourway_v2_verify_freeze()
%FOURWAY_VERIFY_FREEZE Reject altered design, policy, equations or replay.
root=fourway_v2_root();
manifest=jsondecode(fileread(fullfile(root,'04_EMI_Models','four_way_emi_v2_freeze_manifest.json')));
...
v1=fourway_verify_freeze();assert(v1.passed);
