...
model='EMI_SC01B_Device_Halfbridge';folder=fullfile(root,'models');
...
ws=get_param(model,'ModelWorkspace');assignin(ws,'sc01bSchema',3);
...
resistor('HighGateResistance',[475 280 550 310], ...
    'sc01bParams.driver.outputResistance_Ohm+sc01bParams.driver.externalResistance_Ohm');
resistor('LowGateResistance',[475 610 550 640], ...
    'sc01bParams.driver.outputResistance_Ohm+sc01bParams.driver.externalResistance_Ohm');
