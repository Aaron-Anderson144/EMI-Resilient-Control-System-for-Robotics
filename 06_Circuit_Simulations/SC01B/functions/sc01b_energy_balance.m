...
balance.GateResistorEnergy_J=(p.driver.outputResistance_Ohm+p.driver.externalResistance_Ohm)* ...
    (product(t,v.highGateCurrent_A,v.highGateCurrent_A)+product(t,v.lowGateCurrent_A,v.lowGateCurrent_A));
